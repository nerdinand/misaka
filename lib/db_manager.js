 ...
 * @param {String} username Username
 */
DbManager.prototype.hasRawrTicket = function(channel, username, callback) {
  if(!this.checkInitialized(callback)) {
    return;
  }
 ...
 * @param {String} username Username
 */
DbManager.prototype.markRawrTicket = function(channel, username, callback) {
  if(!this.checkInitialized(callback)) {
    return;
  }
 ...
 */
DbManager.prototype.purchaseRawrTicket = function(channel, username, cost, callback) {
  if(!this.checkInitialized(callback)) {
    return;
  }
  ...
  this.hasRawrTicket(channel, username, function(err, has) {
    if(!err) {
      if(!has) {
