function CoreModule() {
  this.info = {
    ...
    commands: [
      { name: 'command', callback: CoreModule.prototype.onCommand.bind(this) },
      { name: 'commands', callback: CoreModule.prototype.onCommands.bind(this) },
      { name: 'module', callback: CoreModule.prototype.onModule.bind(this) },
      { name: 'modules', callback: CoreModule.prototype.onModules.bind(this) },
      { name: 'enable', callback: CoreModule.prototype.onEnable.bind(this), master: true },
      { name: 'disable', callback: CoreModule.prototype.onDisable.bind(this), master: true },
      { name: 'load', callback: CoreModule.prototype.onLoad.bind(this), master: true },
      { name: 'unload', callback: CoreModule.prototype.onUnload.bind(this), master: true },
      { name: 'help', callback: CoreModule.prototype.onHelp.bind(this) }
    ],
 ...
 */
CoreModule.prototype.isCommandName = function(name) {
 ...
 */
CoreModule.prototype.isModuleName = function(name) {
 ...
 */
CoreModule.prototype.onSetStatus = function(data, status) {
...
CoreModule.prototype.onCommand = function(data) {
  if(data.parsed.tail) {
 ...
 * @param data Command data
 */
CoreModule.prototype.onCommands = function(data) {
  if(data.parsed.tail) {
 ...
 * @param data Command data
 */
CoreModule.prototype.onDisable = function(data) {
 ...
 * @param data Command data
 */
CoreModule.prototype.onEnable = function(data) {
 ...
 * @param data Command data
 */
CoreModule.prototype.onModule = function(data) {
  if(data.parsed.tail) {
...
CoreModule.prototype.onModules = function(data) {
  var names = [];
...
CoreModule.prototype.onLoad = function(data) {
  // Todo
};

CoreModule.prototype.onUnload = function(data) {
...
CoreModule.prototype.onHelp = function(data) {
  return 'Command help: https://github.com/saneki/misaka/blob/master/HELP.md';
};
