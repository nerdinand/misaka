...
function RawrModule() {
  this.info = {
    ...
    commands: [
      { name: 'gg', modes: 'whisper', callback: RawrModule.prototype.onGame.bind(this) },
      { name: 'guess', callback: RawrModule.prototype.onGuess.bind(this) },
      { name: 'ggrules', callback: RawrModule.prototype.onGameRules.bind(this) },
      { name: 'ggticket', callback: RawrModule.prototype.onGameTickets.bind(this) },
      { name: 'mark', callback: RawrModule.prototype.onMarkTicket.bind(this) },
      { name: 'rp', callback: RawrModule.prototype.onRawrPoints.bind(this) },
      { name: 'rpredeem', callback: RawrModule.prototype.onRawrPointsRedeem.bind(this) },
      { name: 'sketchraffle', callback: RawrModule.prototype.onSketchRaffle.bind(this) },
      { name: 'streamtipraffle', callback: RawrModule.prototype.onStreamTipRaffle.bind(this) }
...
RawrModule.prototype.onSketchRaffle = function(data) {
  return 'http://www.lumineko.com/sr';
};

RawrModule.prototype.onStreamTipRaffle = function(data) {
